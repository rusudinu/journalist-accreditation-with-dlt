...
class ScanVP extends StatefulWidget {
  const ScanVP({super.key});

  @override
  State<ScanVP> createState() => _ScanVPState();
}

class _ScanVPState extends State<ScanVP> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        fit: StackFit.expand,
        children: [
          if (loadingCamera) const Center(child: CircularProgressIndicator()),
          if (!loadingCamera)
            MobileScanner(
              fit: BoxFit.contain,
